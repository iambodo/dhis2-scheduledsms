...
DT::datatable(sent_sms_table, 
              caption = "All SMS sent (blocked #s)",
              extensions = 'Buttons', 
              options = list(
                pageLength = 10,
                dom = 'Blfrtip', 
...
DT::datatable(sched_events_table, 
              caption = "All Scheduled Events, by OU",
              extensions = 'Buttons', 
              options = list(
                pageLength = 5,
                dom = 'Blfrtip', 
...
DT::datatable(sched_sms_table, 
              caption = "All SMS Messages Scheduled, by type",
              extensions = 'Buttons', 
              options = list(
                pageLength = 5,
                dom = 'Blfrtip', 
